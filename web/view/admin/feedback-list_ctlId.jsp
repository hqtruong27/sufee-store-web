                    ...
                    <div class="card">
                        <div class="card-header">
                            <c:forEach items="${listFeebackCatalog}" var="fbcatalog">
                                <c:if test="${fbcatalog.feedbackCatalogId == feedback.feedbackCatalogs.feedbackCatalogId}">
                                    <strong class="card-title">${fbcatalog.feedbackCatalogName}</strong>
                                </c:if>
                            </c:forEach>
                        </div>
                        <div class="card-body">
                            ...
                            <table id="myTable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <c:forEach items="${feedbacks}" var="list">
                                        <tr id="rows_${list.feedbackId}">
                                            <td>${list.fullname}</td>
                                            <td>${list.email}</td>
                                            <td>${list.phone}</td>
                                            <td><i class="ti-timer mr-2 text-primary"></i>${list.feedbacksTime}</td>
