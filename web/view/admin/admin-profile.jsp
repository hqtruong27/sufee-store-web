                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mx-auto d-block">
                                <img class="rounded-circle mx-auto d-block" src="${pageContext.request.contextPath}/view/admin/uploads/admin.jpg" alt="Card image cap">
                                <h5 class="text-sm-center mt-2 mb-1">Steven Lee</h5>
                                <div class="location text-sm-center"><i class="menu-icon mr-2 text-secondary ti-email"></i> ltlam.bkap@gmail.com</div>
                                <div class="location text-sm-center"><i class="menu-icon mr-2 text-secondary fa fa-phone"></i> 099999999</div>
                            </div>
                            <hr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mx-auto d-block">
                                ...
                                <h5 class="text-sm mt-2 mb-1">Steven Lee</h5>
                                <div class="location text-sm"><i class="menu-icon mr-2 text-secondary  fa fa-user"></i> Giới tính:</div>
                                <div class="location text-sm"><i class="menu-icon mr-2 text-secondary  fa fa-calendar-o"></i> Ngày sinh:</div>
                                <div class="location text-sm"><i class="menu-icon mr-2 text-secondary  ti-email"></i> Email:</div>
                                <div class="location text-sm"><i class="menu-icon mr-2 text-secondary  fa fa-phone"></i> Điện thoại:</div>
                                <div class="location text-sm"><i class="menu-icon mr-2 text-secondary  ti-eye"></i> Địa chỉ:</div>
                            </div>
                            <hr>
                            <div class="card-text text-sm-center">
                                <a href="#"><i class="fa fa-facebook pr-1"></i></a>
