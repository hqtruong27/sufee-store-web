<%-- 
    ...
    Created on : Aug 14, 2020, 11:22:47 AM
    Author     : ADMIN
--%>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Thêm mới logo</strong> 
                    </div>
                    <div class="card-body card-block">
                        <f:form action="create-logo.htm" commandName="logo" method="POST"  class="form-horizontal">    
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <div class="show-for-logoImage"/></div>
                            </div>
                        </div>
    ...
    (function ($) {
        $("#btn-upload").click(function (event) {
            ...
            finder.selectActionFunction = function (url) {
                $("#logoImage").val(url);
                $(".show-for-logoImage").html("<img src='/Sufee_Store" + url + "' width='150' />");
            };
            finder.popup();
        });
    })(jQuery);
