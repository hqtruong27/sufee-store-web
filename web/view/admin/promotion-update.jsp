                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Chỉnh sửa chương trình khuyến mãi</strong> 
                        </div>
                        <div class="card-body card-block">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">    
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tên chương trình khuyến mãi</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input"  class="form-control"><small class="form-text text-muted">Thêm tên</small></div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><textarea name="textarea-input" id="textarea-input" rows="9" required="required" class="form-control"></textarea>
                                        <script>CKEDITOR.replace('textarea-input');</script>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Ngày bắt đầu</label></div>
                                    <div class="col-12 col-md-9"><input type="date" id="text-input" name="text-input"  class="form-control"></div>
                                </div>
                                <div class="row form-group">
