        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title mb-3">Chi tiết tin tức</strong>
                        </div>
                            ...
                            <div class="mx-auto d-block">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <p><i class="menu-icon mr-2 text-info ti-user"></i>
                                        ...
                                        <tr>
                                            <td>
                                                <p>
                                                    <strong>${news.newDescription}</strong>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <p>
                                                    <img src="${pageContext.request.contextPath}${news.newImage}" alt="" class="img-circle"/>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="btn btn-success btn-sm">
                                        <a class="location text-left text-white" href="<%=request.getContextPath()%>/admin/news.htm" data-toggle="tooltip" data-placement="top-center" title="Quay về"><i class="ti-back-left"></i> Trở lại</a>
                                    </div>
                ...
                <div class="col-md-3 ">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title mb-3">Thông tin liên quan</strong>
                            ...
                            <div class="card">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <c:forEach items="${catalogses}" var="catalog">
                                                    <p>
                                                        ${catalog.catalogName}
                                                    </p>
                                                </c:forEach>
