                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Thêm mới tin tức</strong> 
                        </div>
                        <div class="card-body card-block">
                            <f:form action="create-news.htm" method="post" commandName="new" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="newTitle" class=" form-control-label">Tiêu đề</label></div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="catalogs.catalogId" id="catalogId" class="form-control" required="Điền vào đây">
                                            <option value="">Vui lòng chọn</option>       
                                            <c:forEach items="${listCatalog}" var="list">
                                                <option value="${list.catalogId}">${list.catalogName}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        ...
                                        <f:input type="text" id="newImage" readonly="true" multiple="false" path="newImage" class="form-control" cssStyle="border-left: none; border-radius: 0;margin-left: -4px;max-width: 766px;display: inline-block;" />
