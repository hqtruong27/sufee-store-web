                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-6">
                                    <p style="float: right" class="">
                                        <a data-placement="top" data-toggle="tooltip" class="btn btn-info btn-sm mr-2" title="Tới trang danh mục cấp 2" href="<%=request.getContextPath()%>/admin/parent-catalog.htm"><i class="menu-icon ti ti-arrow-right"></i> Danh mục tin tức cấp 2</a>
                                    </p>
                                </div>
                            </div>
                            <table id="myTable" class="table table-striped table-bordered">
                                ...
                                <tbody id="dgvCatalogs">
                                    <c:forEach items="${catalogses}" var="c">
                                        <tr>
                                            <td>${c.catalogName}</td>
                                            <td>${c.piority}</td>
                                            <td>
