                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Hãng sản xuất</strong>
                        </div>
                        <div class="card-body">
                            <p>
                                <a href="create-brand.htm"><button type="button" class="btn btn-success btn-sm mr-2"><i class="menu-icon ti-plus"></i>&nbsp; Thêm hãng mới</button></a>
                            </p>
                            <table id="myTable" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>Tên hãng</th>
                                        <th>Độ ưu tiên của hãng</th>
                                        <th>Trạng thái</th>
                                        <th>Hành động</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach items="${listBrand}" var="brand">
                                        <tr>
                                            <td>
                                                <img src="${brand.brandLogo}" alt="${brand.brandName}" width="60" class="img-circle">
                                                <span>${brand.brandName}</span>
                                            </td>
                                            <td>${brand.brandPiority}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a class="mr-3" href="update-brand.htm?brandId=${brand.brandId}" data-toggle="tooltip" data-placement="top-center" title="Chỉnh Sửa"><span class="ti-pencil"></span></a>
                                                <a data-id="${brand.brandId}" class="btn-delete" href="" data-toggle="modal" data-target="#staticModal"><span data-toggle="tooltip" data-placement="top" title="Xóa" class="ti-trash"></span></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
