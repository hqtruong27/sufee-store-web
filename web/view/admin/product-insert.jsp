                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">      
                            <f:form action="create-product.htm" commandName="product" method="POST"  class="form-horizontal">    
                                <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <c:if test="${not empty errorproductcode}"> <small class="form-text text-danger">${errorproductcode}</small></c:if>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="categoryId" class=" form-control-label">Danh mục ${required}</label></div>
                                        <div class="col-12 col-md-9">
                                            ...
                                            <c:forEach items="${newListCategoriesNoParent}" var="cateNoParent">
                                                <option value="${cateNoParent.categoryId}">${cateNoParent.categoryName}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="brandId" class=" form-control-label">Hãng sản xuất ${required}</label></div>
                                    <div class="col-12 col-md-9">
                                        <select name="brands.brandId" id="brandId" class="form-control" required oninvalid="this.setCustomValidity('Vui lòng chọn thương hiệu')" oninput="this.setCustomValidity('')" >
                                            ...
                                            <c:forEach items="${listBrands}" var="lb">
                                                <option value="${lb.brandId}">${lb.brandName}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="show-for-featureImage"/></div>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <small class="form-text text-muted">Nhiều ảnh</small>
                                    <div class="show-for-images"/></div>
                            </div>
                        </div>
                        <div class="row form-group">
