<%-- 
    ...
    Created on : Aug 5, 2020, 8:46:33 PM
    Author     : Kai
--%>
                ...
                <c:if test="${not empty InfoAdmin}">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="${pageContext.request.contextPath}/view/admin/uploads/avatar/${admin.avatar}" alt="User Avatar">
                        </a>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <f:form action="update-admin.htm" commandName="admin" method="POST"  class="form-horizontal">    
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="passwords" class=" form-control-label">Mật khẩu</label></div>
                                    <div class="col-12 col-md-9">
                                        <f:input type="password" path="passwords"  class="form-control" />
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="birthday" class=" form-control-label">Ngày sinh</label></div>
                                    <div class="col-12 col-md-9">
                                        <fmt:formatDate value="${admin.birthday}" pattern="dd/MM/yyyy" var="birthday" />
                                        <f:input type="text" path="birthday" value="${birthday}" class="form-control"/>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="gender" id="gender" class="form-control">
                                            <option <c:if test="${admin.gender == 1}">selected</c:if> value="1">Nam</option>
                                            <option <c:if test="${admin.gender == 0}">selected</c:if> value="0">Nữ</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row form-group">
...
<!--                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="avatar" class=" form-control-label">Ảnh đại diện</label></div>
                                    <div class="col-12 col-md-9">
                                        <a id="btn-upload" class="btn btn-secondary " style="display: inline-block;margin-top: -6px">Chọn ảnh</a>
                                        <f:input  type="text" id="avatar" readonly="true" multiple="false" path="avatar" class="form-control" cssStyle="border-left: none; border-radius: 0;margin-left: -4px;max-width: 766px;display: inline-block;" />
                                        <small class="form-text text-muted">Hình ảnh đại diện của nhân viên</small>
                                        <div class="show-for-avatar"/></div>
                                </div>
                            </div>-->
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="status" id="status" class="form-control">
                                        <option <c:if test="${admin.status == 1}">selected</c:if> value="1">Kích hoạt</option>
                                        <option <c:if test="${admin.status == 0}">selected</c:if> value="0">Tạm khoá</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row form-group">
    ...
    (function ($) {
        $("#btn-upload").click(function (event) {
            ...
            finder.selectActionFunction = function (url) {
                $("#avatar").val(url);
                $(".show-for-avatar").html("<img src='/Sufee_Store" + url + "' width='60' />");
            };
            finder.popup();
        });
    })(jQuery);
