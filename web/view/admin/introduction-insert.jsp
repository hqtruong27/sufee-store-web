<%-- 
    Document   : introduction-insert
    Created on : Aug 17, 2020, 11:55:27 PM
    Author     : Kai
--%>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong>Thêm mới Intro</strong> 
                    </div>
                    <div class="card-body card-block">

                        <f:form action="create-intro.htm" commandName="intro" method="POST"  class="form-horizontal">    
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <f:errors path="introductionContent" cssStyle="color:red"/>
                                </div>
                            </div>
