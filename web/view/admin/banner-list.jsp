<%-- 
    Document   : banner-lists
    Created on : Aug 10, 2020, 11:52:55 PM
    Author     : Kai
--%>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Danh mục banner</strong>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-xs-6">
                                    <a data-toggle="tooltip" title="Thêm mới banner" href="<%=request.getContextPath()%>/admin/create-banner.htm"><button type="button" class="btn btn-success btn-sm mr-2"><i class="menu-icon ti-plus"></i>&nbsp; Thêm mới</button></a>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="myTable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listBanner}" var="banner">
                                            <tr>
                                                <td>${banner.bannerPiority}</td>
                                                <td>
                                                    <img src="${banner.bannerImage}" alt="NoImg" width="50" class="img-circle">
                                                </td>
                                                ...
                                                <td>
                                                    <a class="mr-3" href="update-banner.htm?bannerId=${banner.bannerId}" data-toggle="tooltip" data-placement="top-center" title="Chỉnh Sửa"><span class="ti-pencil"></span></a>
                                                    <a data-id="${banner.bannerId}" class="btn-delete" ><span data-toggle="tooltip" data-placement="top" title="Xóa" class="ti-trash"></span></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
        ...
        (function ($) {
            ...
            $(".btn-delete").on("click", function (e) {
                ...
                $("#confirmdelete").on("click", function () {
                    $.ajax({
                        type: 'POST',
                        url: "delete-banner.htm",
                        data: {bannerId: id},
                        success: function (res) {
                            if (res === "success") {
                                $("#staticModal").modal('hide');
                                window.location.replace("banner.htm");
                            }
                        }
                    });
                });
