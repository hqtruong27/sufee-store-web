<%-- 
    ...
    Created on : Aug 11, 2020, 1:13:35 AM
    Author     : Kai
--%>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <f:form action="update-banner.htm" commandName="banner" method="POST"  class="form-horizontal">    
                                <f:hidden path="bannerId" />
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="bannerPiority" class=" form-control-label">Độ ưu tiên</label></div>
                                    <div class="col-12 col-md-9">
                                        <f:input type="text" path="bannerPiority"  class="form-control" />
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="bannerImage" class=" form-control-label">Banner</label></div>
                                    <div class="col-12 col-md-9">
                                        <small class="form-text text-muted">Chọn banner</small>
                                        ...
                                        <div class="show-for-banner"/><img src="${pageContext.request.contextPath}/${banner.bannerImage}" width="150" /></div>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <f:input path="bannerDescription"  class="form-control" />
                                </div>
                            </div>        
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="bannerStatus" id="bannerStatus" class="form-control">
                                        <option <c:if test="${banner.bannerStatus == 1}">selected</c:if> value="1">Hiển thị</option>
                                        <option <c:if test="${banner.bannerStatus == 0}">selected</c:if> value="0">Tạm ẩn</option>
                                        </select>
                                    </div>
                                </div>
    ...
    (function ($) {
        $("#btn-upload").click(function (event) {
            ...
            finder.selectActionFunction = function (url) {
                $("#bannerImage").val(url);
                $(".show-for-banner").html("<img src='/Sufee_Store" + url + "' width='150' />");
            };
            finder.popup();
        });
    })(jQuery);
