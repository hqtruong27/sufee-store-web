                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-xs-6">
                                    <a data-toggle="tooltip" title="Thêm mới danh mục" href="create-category.htm"><button type="button" class="btn btn-success btn-sm mr-2"><i class="menu-icon ti-plus"></i>&nbsp; Thêm mới</button></a>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                    <p style="float: right" class="">
                                        <a data-placement="top" data-toggle="tooltip" class="btn btn-info btn-sm mr-2" title="Tới trang danh mục cấp 2" href="<%=request.getContextPath()%>/admin/categories-parent.htm"><i class="menu-icon ti ti-arrow-right"></i> Danh mục cấp 2</a>
                                    </p>
                                </div>
                            </div>
                ...
                $("#confirmdelete").on("click", function () {
                    $.ajax({
                        ...
                        success: function () {
                            ...
                            window.location.replace("categories.htm");
                        }
                    });
                });
            });
