                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <f:form action="update-brand.htm" commandName="brand" method="POST"  class="form-horizontal">    
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="brandId" class=" form-control-label">ID hãng</label></div>
                                    <div class="col-12 col-md-9">
                                        <f:hidden path="brandId" />
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="brandName" class=" form-control-label">Tên hãng</label></div>
                                    <div class="col-12 col-md-9">
                                        <f:input path="brandName"  class="form-control" />
                                    </div>
                                </div>

                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="brandPiority" class=" form-control-label">Độ ưu tiên</label></div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" name="brandPiority" value="${brand.brandPiority}"  class="form-control" required oninvalid="this.setCustomValidity('Vui lòng chọn vị trí sắp xếp')" oninput="this.setCustomValidity('')" />
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="brandLogo" class=" form-control-label">Logo hãng</label></div>
                                    <div class="col-12 col-md-9">
                                        <small class="form-text text-muted">Chọn ảnh logo hãng</small>
                                        <a id="btn-upload" class="btn btn-secondary " style="display: inline-block;margin-top: -6px">Chọn ảnh</a>
                                        <f:input  type="text" id="brandLogo" readonly="true" multiple="false" path="brandLogo" class="form-control" cssStyle="border-left: none; border-radius: 0;margin-left: -4px;max-width: 766px;display: inline-block;" />
                                        <div class="show-for-brandLogo"/><img src="${brand.brandLogo}" width="150" /></div>
                                </div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="brandStatus" class=" form-control-label">Trạng thái</label></div>
                                <div class="col-12 col-md-9">
                                    <select name="brandStatus" id="brandStatus" class="form-control">
                                        <option <c:if test="${brand.brandStatus == 1}">selected</c:if> value="1">Hiển thị</option>
                                        <option <c:if test="${brand.brandStatus == 0}">selected</c:if> value="0">Tạm ẩn</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        ...
                                        <a href="brand.htm" type="reset" class="btn btn-danger btn-sm">
    ...
    (function ($) {
        $("#btn-upload").click(function (event) {
            ...
            finder.selectActionFunction = function (url) {
                $("#brandLogo").val(url);
                $(".show-for-brandLogo").html("<img src='" + url + "' width='150' />");
            };
            finder.popup();
        });
    })(jQuery);
