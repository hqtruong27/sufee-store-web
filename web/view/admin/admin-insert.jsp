<%-- 
    ...
    Created on : Aug 5, 2020, 10:31:05 AM
    Author     : Kai
--%>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <f:form action="create-admin.htm" commandName="admin" method="POST"  class="form-horizontal">    
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="fullname" class=" form-control-label">Tên nhân viên</label></div>
                                    <div class="col-12 col-md-9">
                                        <f:input id="fullname" path="fullname"  class="form-control" />
                                        <f:errors path="fullname" cssStyle="color:red"/>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="email" class=" form-control-label">Email</label></div>
                                    <div class="col-12 col-md-9">
                                        <f:input type="email" id="email" path="email"  class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <f:input type="password" id="passwords" path="passwords"  class="form-control" />
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="birthday" class=" form-control-label">Ngày sinh</label></div>
                                    <div class="col-12 col-md-9">
                                        <f:input type="date" id="birthday" path="birthday"  class="form-control"/>
                                    </div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <f:input type="text" id="idCard" path="idCard"  class="form-control" />
                                    </div>
                                </div>
<!--                                <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <f:errors path="adminAddress" cssStyle="color:red"/>
                                </div>
                            </div>
                            <div class="row form-group">
