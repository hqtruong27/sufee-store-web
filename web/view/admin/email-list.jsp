            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>
                                <a href="<%=request.getContextPath()%>/view/admin/email-send.jsp"><button type="button" class="btn btn-success btn-sm mr-2"><i class="menu-icon ti-plus"></i>&nbsp; Gửi email</button></a>
                            ...
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="mr-3" href="<%=request.getContextPath()%>/view/admin/email-view.jsp" data-toggle="tooltip" data-placement="bottom" title="Chi tiết"><span class="ti-eye"></span></a>
                                            <!--                                        <a class="mr-3" href="" data-toggle="tooltip" data-placement="top-center" title="Chỉnh Sửa"><span class="ti-pencil"></span></a>
