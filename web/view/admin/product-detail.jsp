        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title mb-3">Ảnh sản phẩm</strong>
                        </div>
                        <div class="card-body">
                            <div class="mx-auto d-block">
                                <img class=" mx-auto d-block" src="${pageContext.request.contextPath}/view/admin/uploads/productImages/productImage1562155220037.jpg" alt="Card image cap">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title mb-3">Thông tin</strong>
                        </div>
                        <div class="card-body">
                            <div class="mx-auto d-block ">
                                <div class="border-bottom"><h5 class="text-sm mt-2 mb-3 pb-3" >Máy Dập</h5></div>
                                <div class="border-bottom">
                                    <h4 class="text-sm mt-2 mb-3 pb-3" >Danh mục</h4>
                                </div>
                                <div><h4 class="text-sm mt-2 mb-3 pb-2" >Số lượng bán ra:</h4></div>
                                <div><h4 class="text-sm mt-2 mb-3 pb-2" >Ngày tạo:</h4></div>
                                <div><h4 class="text-sm mt-2 mb-3 pb-2" >Ngày cập nhật:</h4></div>
                                <div><h4 class="text-sm mt-2 mb-3 pb-2" >Người cập nhật:</h4></div>
                                <div>
                                    <a href="<%=request.getContextPath()%>/view/admin/product-update.jsp" class="btn btn-success btn-sm mr-2"><i class="menu-icon ti-pencil-alt"></i>&nbsp; Chỉnh sửa sản phẩm</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="product-tab" data-toggle="tab" href="#product" role="tab" aria-controls="product" aria-selected="true">Thông số kỹ thuật</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="images-tab" data-toggle="tab" href="#images" role="tab" aria-controls="images" aria-selected="false">Hình ảnh</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="fag-tab" data-toggle="tab" href="#fag" role="tab" aria-controls="fag" aria-selected="false">Đánh giá</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="content-tab" data-toggle="tab" href="#content" role="tab" aria-controls="content" aria-selected="false">Mô tả</a>
                    </li>
                    <li class="nav-item">
                    </li>
                </ul>
                <div class="tab-content pl-3 p-1" id="myTabContent">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Chip AMD Rezen 5 4600H</td>
                                            <td>10.000.000 vnd</td>
                                            <td sc>
                                                <a class="mr-3" href="" data-toggle="tooltip" data-placement="bottom" title="Chi tiết"><span class="ti-eye "></span></a>
                                                <a class="mr-3" href="<%=request.getContextPath()%>/view/admin/promotion-update.jsp" data-toggle="tooltip" data-placement="top-center" title="Chỉnh Sửa"><span class="ti-pencil"></span></a>
                    ...
                    <div class="tab-pane fade" id="fag" role="tabpanel" aria-labelledby="fag-tab">
                    </div>
