                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <f:form action="create-brand.htm" commandName="brand" method="POST"  class="form-horizontal">    
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="brandName" class=" form-control-label">Tên hãng</label></div>
                                    <div class="col-12 col-md-9">
                                        <f:input id="brandName" path="brandName"  class="form-control" />
                                        <f:errors path="brandName" cssStyle="color:red"/>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        ...
                                        <small class="form-text text-muted">Chọn logo hãng</small>
                                        <div class="show-for-brandLogo"/></div>
                                </div>
                            </div>
