                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Danh mục chương trình khuyến mãi</strong>
                        </div>
                        <div class="card-body">
                            <p>
                                <a href="<%=request.getContextPath()%>/view/admin/promotion-insert.jsp">
                                    <button type="button" class="btn btn-success btn-sm mr-2"><i class="menu-icon ti-plus"></i>&nbsp; Thêm mới chương trình khuyến mãi</button>
                                </a>
                            </p>
