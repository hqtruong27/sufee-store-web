                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Thêm mới danh mục tin tức</strong> 
                        </div>
                        <div class="card-body card-block">
                            <f:form action="create-catalog.htm" method="post" commandName="catalogs" class="form-horizontal">    
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        ...
                                        <c:if test="${not empty error}"><small class="form-text text-danger">${error}</small></c:if>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="parentId" id="parentId"  required="" class="form-control">
                                            ...
                                            <c:if test="${not empty catalogses}">
