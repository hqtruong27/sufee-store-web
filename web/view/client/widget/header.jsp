                    ...
                    <nav>
                        <div class="pull-left dp-flex">
                            <div class="header-logo">
                                <a class="logo" href="${pageContext.request.contextPath}/trang-chu.htm">
                                    <img src="${pageContext.request.contextPath}/view/client/uploads/free_horizontal_on_white_by_logaster (4).png" alt="">
                                </a>
                            </div>
                                                    ...
                                                    <c:forEach items="${shoppingCart.carts}" var="c">
                                                        <div class="product product-widget">
                                                            ...
                                                            <div class="product-body">
                                                                <h2 class="product-name"><a href="${pageContext.request.contextPath}/san-pham/chi-tiet.htm?productId=${c.products.productId}">${c.products.productName}</a></h2>
